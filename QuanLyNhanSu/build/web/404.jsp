...
<html>
    ...
    <body>
        <div class="errorPageRap">
            ...
            <h1>
                Bạn không có quyền truy cập trang Admin... <span><img src="images/sadFace.png"></span>
                <br>
                Nếu bạn là Admin của website, hãy trở lại trang đăng nhập,<a href="index.jsp">Đăng Nhập</a>
            </h1>
        </div>
    </body>
</html>
