...
<html>
    ...
    <body>
        ...
        %>
        <header class="header dark-bg" style="background-color: rgba(0, 0, 0, 0.34);">
            <div class="toggle-nav">
                <div class="icon-reorder tooltips" data-original-title="Toggle Navigation" data-placement="bottom"><i class="icon_menu"></i></div>
            </div>

            <!--logo start-->
            <!--<a href="indexAdmin.jsp" class="logo">Quản Lý Nhân Sự <span class="lite"></span></a>-->
            <!--logo end-->

            <div class="nav search-row" id="top_menu" style="background-color: rgba(0, 0, 0, 0.34);">
                <!--  search form start -->
<!--                <ul class="nav top-menu">
                    <li>
                        <form class="navbar-form">
                            <input class="form-control" style="background-color: rgba(0, 0, 0, 0.34);" placeholder="Search" type="text">
                        </form>
                    </li>
                </ul>-->
                <!--  search form end -->
...
<!--                            <span class="profile-ava">
                                <img alt="" src="img/avatar1.jpg" style="width: 50px;">
                            </span>-->
                            <span class="username">Xin chào,<%=u.getUsername()%></span>
                            <%
                                }
                            %>
                            <b class="caret"></b>
...
<!--                            <li class="eborder-top">
                            ...
                            <li>
                                <a href="XuLyDangXuat"><i class="icon_key_alt"></i>Đăng Xuất</a>
                            </li>
<!--                            <li>
